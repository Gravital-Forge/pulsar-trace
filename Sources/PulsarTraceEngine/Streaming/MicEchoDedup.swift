...
/// once as `You`.
///
/// R19's rule: when a mic utterance's text is **more than 0.5 similar** to a
...
public struct MicEchoDedup {
    ...
    /// Similarity above which a mic utterance counts as an echo (R19: > 0.5).
    public let similarityThreshold: Double
    /// Half-width of the time window an echo may be offset by (R19: ±5 s).
    ...
    ///   meaning the caller should **drop this mic line** (R19).
