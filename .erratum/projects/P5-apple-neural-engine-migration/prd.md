...
**Status:** Frozen · **Opened:** 2026-06-12 · **Closed:** 2026-06-24

<!-- Closed at project close-out, at the merge-to-main point, when the change-types below were
     reconciled into the product layer (requirements.md, architecture/, traceability.md). -->
...
*Supersedes:* PT-R9; introduces PT-R107. *Acceptance:* a fixture transcribes through the ANE
...
*Supersedes:* PT-R54c; introduces PT-R108. *Acceptance:* models download via the SDKs into
...
*Supersedes:* PT-R54d; introduces PT-R109. *Acceptance:* `model_downloaded` carries a
