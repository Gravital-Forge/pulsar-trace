...
| ------------------- | ----- |
| PT-P1-R5 | `Sources/PulsarTraceEngine/Diarization/` — `Diarizer.swift`, `DiarizationJSON.swift`, `SpeakerSpan.swift`, `DiarizedTranscript.swift`; `python/pulsartrace-ai` diarization script |
